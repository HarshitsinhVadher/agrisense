...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, padding: 10, fontSize: 14, marginBottom: 10, backgroundColor: '#ffffff', color: '#000000' },
  ...
  authInput: { borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, padding: 12, fontSize: 14, backgroundColor: '#ffffff', color: '#000000' },
